...
function obterAlturaMedia() {
  ...
  return Math.round((totalAltura / 12) * 100) / 100;
}
...
return Math.round((totalPeso / comPesoQualificavel.length) * 100) / 100;
...
function obterPesoMedioDoadores () {
  ...
  return Math.round((totalPeso / doadores.length) * 100) / 100;
}
